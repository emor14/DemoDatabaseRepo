...
CREATE procedure [dbo].[usp_calculateResourceLoadForProject]
	@startDate date,
	@endDate date,
	@projID int 
as 
	...
	begin
		 ...
		 begin
			...
			begin
				...
				exec usp_calculateResourceLoadForTask @projId, @subtaskId, @topLevelTaskUnderProcess, 
					@subTaskStartDate,@duration, @concSubTaskId, @taskEndDatetime output
